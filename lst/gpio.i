...
void GPIO_init()
{
	DrvGPIO_Open(E_PORT2, E_PIN0, E_IO_QUASI);
	DrvGPIO_Open(E_PORT2, E_PIN1, E_IO_QUASI);
	DrvGPIO_Open(E_PORT2, E_PIN1, E_IO_QUASI);
	DrvGPIO_Open(E_PORT2, E_PIN2, E_IO_QUASI);	 
	DrvGPIO_Open(E_PORT2, E_PIN3, E_IO_QUASI);
	DrvGPIO_Open(E_PORT2, E_PIN4, E_IO_QUASI);
	DrvGPIO_Open(E_PORT2, E_PIN5, E_IO_QUASI);
	...
	DrvGPIO_Open(E_PORT0, E_PIN5, E_IO_QUASI);
	DrvGPIO_Open(E_PORT4, E_PIN4, E_IO_QUASI);
	DrvGPIO_Open(E_PORT4, E_PIN5, E_IO_QUASI);

	DrvGPIO_Open(E_PORT0, E_PIN1, E_IO_INPUT);
	DrvGPIO_Open(E_PORT0, E_PIN2, E_IO_INPUT);
	DrvGPIO_Open(E_PORT0, E_PIN0, E_IO_OUTPUT);
	DrvGPIO_Open(E_PORT3, E_PIN7, E_IO_OUTPUT);
	DrvGPIO_Open(E_PORT3, E_PIN6, E_IO_OUTPUT);
	DrvGPIO_Open(E_PORT3, E_PIN3, E_IO_OUTPUT);

	DrvGPIO_Open(E_PORT3, E_PIN5, E_IO_QUASI);
	DrvGPIO_Open(E_PORT3, E_PIN4, E_IO_QUASI);
