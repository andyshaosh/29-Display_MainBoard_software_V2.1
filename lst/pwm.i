...
void PWM_init()

 {
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PCR.CH0INV=1;
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PCR.DZEN01=0;
    ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PCR.DZEN23=0;
	  
	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR0=5500/20;	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0=100;

	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR1=5500/20;	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1=100;

	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR2=5500/20;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2=100;

	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR3=5500/20;	
...
void SetBL_PWM(uint8_t PWMvalue)
{
 	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0=PWMvalue;
