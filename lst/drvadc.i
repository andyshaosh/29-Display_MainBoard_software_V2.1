#line 1 "Library\\Src\\Driver\\DrvADC.c"
...
#line 12 "Library\\Src\\Driver\\DrvADC.c"
#line 13 "Library\\Src\\Driver\\DrvADC.c"
...
#line 14 "Library\\Src\\Driver\\DrvADC.c"
...
#line 15 "Library\\Src\\Driver\\DrvADC.c"
...
void DrvADC_Open(E_ADC_INPUT_MODE InputMode, E_ADC_OPERATION_MODE OpMode, uint8_t u8ChannelSelBitwise, E_ADC_CLK_SRC ClockSrc, uint8_t u8AdcDivisor)
{
    ...
    if( OpMode == ADC_SINGLE_OP )
        ...
        ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR.ADMD = 1;      
...
uint32_t DrvADC_GetConversionRate(void)
{
    if( ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.ADC_S == 0 )            
    {
        return ((12000000UL)/(((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV.ADC_N + 1)/27);
    }
    else if( ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.ADC_S == 1 )       
    {
...
void DrvADC_EnableExtTrigger(E_ADC_EXT_TRI_COND TriggerCondition)
{
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->PMD.PMD2 = 0;                   
