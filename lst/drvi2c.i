#line 1 "Library\\Src\\Driver\\DrvI2C.c"
...
#line 7 "Library\\Src\\Driver\\DrvI2C.c"
...
#line 8 "Library\\Src\\Driver\\DrvI2C.c"
...
int32_t DrvI2C_Open(uint32_t u32BusClock)
{
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2C_EN = 1;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C_RST = 1;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C_RST = 0;	
...
int32_t DrvI2C_Close(void)
{
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C_RST = 1;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C_RST = 0;
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2C_EN = 0;
...
uint32_t DrvI2C_GetClockFreq(void)
{
	...
	divider = ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CLK;
