#line 1 "Library\\Src\\Driver\\DrvSYS.c"
...
#line 7 "Library\\Src\\Driver\\DrvSYS.c"
...
#line 8 "Library\\Src\\Driver\\DrvSYS.c"
...
int32_t DrvSYS_SelectHCLKSource(uint8_t u8ClkSrcSel)
{
	...
	else
	{
		...
		if (((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS.CLK_SW_FAIL)
		{
...
void DrvSYS_EnterPowerDown(E_SYS_PD_TYPE ePDType)
{	
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.PWR_DOWN = 0;
...
int32_t DrvSYS_Open(uint32_t u32Hclk)
{
	...
	if (((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.PLL_SRC == 0)
	{
		...
		while (((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS.XTL12M_STB	== 0);
	...
	else
	{
		...
		while (((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS.OSC22M_STB	== 0);
	...
	while (((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS.PLL_STB == 0);
