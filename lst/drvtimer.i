#line 1 "Library\\Src\\Driver\\DrvTIMER.c"
...
#line 15 "Library\\Src\\Driver\\DrvTIMER.c"
...
#line 16 "Library\\Src\\Driver\\DrvTIMER.c"
...
#line 17 "Library\\Src\\Driver\\DrvTIMER.c"
...
int32_t DrvTIMER_EnableInt(E_TIMER_CHANNEL ch)
{
    switch (ch)
    {
        case E_TMR0:
        {
			...
			NVIC_SetPriority(TMR0_IRQn, (1<<2) - 2);
        ...
        case E_TMR1:
        {
			...
			NVIC_SetPriority(TMR1_IRQn, (1<<2) - 2);
        ...
        case E_TMR2:
        {
			...
			NVIC_SetPriority(TMR2_IRQn, (1<<2) - 2);
        ...
        case E_TMR3:
        {
			...
			NVIC_SetPriority(TMR3_IRQn, (1<<2) - 2);
