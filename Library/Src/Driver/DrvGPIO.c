...
//            outpw(&SYS->P0_MFP, (inpw(&SYS->P0_MFP) | (0x3<<10)) & ~(0x3<<2));		//CTS,RTS配置成功能引脚
			outpw(&SYS->P0_MFP, (inpw(&SYS->P0_MFP) | (0x2<<10)) & ~(0x3<<2));			//CTS配置成普通IO,RTS配置成功能引脚	
//			outpw(&SYS->P0_MFP, (inpw(&SYS->P0_MFP) | (0x0<<10)) & ~(0x0<<2));		  //CTS,RTS配置成普通IO
 		}break;
...
//          outpw(&SYS->P0_MFP, (inpw(&SYS->P0_MFP) | (0x3<<8)) & ~(0x3<<0));
			outpw(&SYS->P0_MFP, (inpw(&SYS->P0_MFP) | (0x0<<8)) & ~(0x0<<0));		  //CTS,RTS配置成普通IO
 		}break;
