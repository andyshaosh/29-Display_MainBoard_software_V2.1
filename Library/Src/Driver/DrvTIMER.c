...
/*					E_DRVTIMER_CHANNEL						Invalid Timer channel / Invalid clock source   */
/* Description:                                                                                            */
...
static uint32_t GetTimerClock(E_TIMER_CHANNEL ch)
{
	...
	if ((ch == E_TMR0) || (ch == E_TMR1) || (ch == E_TMR2) || (ch == E_TMR3))
	{
		...
		{
			//u32clk = 3276800;						/* Option 1: 32K */
    		return E_DRVTIMER_CHANNEL; 		        /* Without RTC function */
		}
		...
		{
			u32clk = __IRC22M; 						/* Option 4: 22MHz*/
		}
	}
	else 
